...
- **Technical preferences**: Read `.claude/docs/technical-preferences.md` â€” extract performance budgets and naming conventions.
...
- **system**: Read `design/gdd/[target-name].md`. Extract the **Visual/Audio Requirements** section. If it doesn't exist or reads `[To be designed]`:
  ...
  Use `AskUserQuestion`: `[A] Describe needs manually` / `[B] Stop â€” complete the GDD first`
...
**Visual Description:**
[2â€“3 sentences. Specific enough for two artists to produce consistent results.]
