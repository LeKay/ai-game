...
- **engine UI specialist** â€” Validates UI implementation patterns against engine-specific best practices (read from `.claude/docs/technical-preferences.md` Engine Specialists â†’ UI Specialist)
...
- `design/gdd/game-concept.md` â€” platform targets and intended audience
...
Before implementation begins, spawn the **engine UI specialist** (from `.claude/docs/technical-preferences.md` Engine Specialists â†’ UI Specialist) to review the UX spec and visual design spec for engine-specific implementation guidance:
